# помечать в оперативке временно отмеченные события 





#реализовать логику получения оповещений(для мероприятий на которые точно пойдет человек), 
# добавления в друзья(если не по рефералке), 
# смотреть мероприятия, 
# на которые пойдет друг, 
# кидать друзьям приглашения на мероприятия,
